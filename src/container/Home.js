...
class Home extends Component {
    ...
    componentDidMount(){
        ...
        const updatedState = func.inputHandler('', 'choice', this.state.choiceElement, 'house wiring')
    ...
    inputHandler = (event) => {
        const updatedState = func.inputHandler(event, 'choice', this.state.choiceElement)
        this.setState({choiceElement: updatedState})
    }
